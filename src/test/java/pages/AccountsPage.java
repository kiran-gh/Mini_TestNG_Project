...
//
//    @FindBy(xpath = "//p[contains(text(),\"Plan details\")]")
//    public WebElement planDetailsHeading;
//
//    @FindBy(xpath = "//p[@class=\"plan-paragraph\"]")
...
//
//    public boolean isMembershipHeadingDisplayed() {
//        wait.until(ExpectedConditions.visibilityOf(membershipHeading));
//        return membershipHeading.isDisplayed();
//    }
//
//    public boolean isMembershipUsernameDisplayed() {
//        wait.until(ExpectedConditions.visibilityOf(membershipUsername));
//        return membershipUsername.isDisplayed();
//    }
//
//    public boolean isMembershipPasswordDisplayed() {
//        wait.until(ExpectedConditions.visibilityOf(membershipPassword));
//        return membershipPassword.isDisplayed();
//    }
//
//    public boolean isPlanDetailsHeadingDisplayed() {
//        wait.until(ExpectedConditions.visibilityOf(planDetailsHeading));
//        return planDetailsHeading.isDisplayed();
//    }
//
//    public boolean isPlanParagraphDisplayed() {
//        wait.until(ExpectedConditions.visibilityOf(planParagraph));
//        return planParagraph.isDisplayed();
//    }
//
//    public boolean isPlanDetailsDisplayed() {
//        wait.until(ExpectedConditions.visibilityOf(planDetails));
//        return planDetails.isDisplayed();
//    }
//
//    public boolean isLogoutButtonDisplayed() {
